...
// Estados de interação do AppBadge clicável (neutral/hovered/pressed/focused/
...
void main() {
  ...
  for (final AppBrandConfig brand in brands) {
    for (final bool dark in <bool>[false, true]) {
      ...
      testWidgets('AppBadge states golden · $label', (tester) async {
        ...
        await expectLater(
          ...
          matchesGoldenFile('goldens/app_badge_states_$label.png'),
        );
      });
    }
  }
