...
The [Flocks](../flocks) component catalog, served to agents over MCP. 133
...
```
Unknown component id "appbadge". Did you mean: "app_badge"? Call list_components to see all 133 ids.
