...
/// leve: o `--tree-shake-icons` ignora esta declaração inteira e embute na
/// fonte só os codepoints que o app realmente escreveu. Escrever o campo direto
/// é o que preserva esse ganho — qualquer coisa que torne os 2.025 alcançáveis
/// de uma vez traz a fonte inteira junto.
///
/// Nomes que o Lucide aposentou não estão aqui, mesmo aparecendo no
/// `codepoints.json` do upstream: eles não têm glifo na fonte, e um campo para
/// eles desenharia vazio. Ver `tool/vendor_lucide.dart`.
@staticIconProvider
abstract final class FlocksLucide {
  /// A família declarada no `pubspec`.
  static const String fontFamily = 'Lucide';

  /// O pacote que embute a fonte.
  static const String fontPackage = 'flocks_lucide';
